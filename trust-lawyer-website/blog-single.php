...
<!-- blog-single.php  22 Nov 2019 12:08:47 GMT -->
<head>
    <meta charset="UTF-8">
    <title>Suprimo</title>
        ...
        <div class="container">
            <div class="flex-header">
                <div id="logo" class="logo">
                    <a href="index-2.php" title="Logo"><img src="images/logo/01.png" data-width="211" data-height="34" alt="images" data-retina="images/logo/01@2x.png"></a>
                </div>
    ...
    <div class="page-title">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="content">
                        <h2 class="title-banner">news single</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="post-wrap mg-blog-res">
                        <article class="main-post mg-bottom-bls">
                            <div class="featured-post">
                                <div class="entry-img">
                                    <a href="#"><img src="images/blog/01.png" alt="images"></a>
                                </div>
                            </div>
                            <div class="post-content content-blog-single clearfix">
                                ...
                                <div class="post-meta-right">
                                    <div class="entry-content-bls">
                                        <h3 class="title"><a href="#">When the musics over turn off the light says Jim Morrison</a></h3>
                                        <ul>
                                            <li class="author"><a href="#" title="">Johnson Doe</a></li>
                                            <li class="categories"><a href="#" title="">Family Law</a></li>
                                            <li class="comment"><a href="#" title="">234 Comments</a></li>
                                        </ul>
                                        <div class="text-content">
                                            <p>
                                                Lemagni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit ametempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                            </p>
                                            <p>
                                                consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit volup
                                            </p>
                                        </div>
                                        <blockquote>
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odiort aut fugit, sed quia consequuntur magni dolores eos qui ratione volues ptatem sequi nesciunt. Neque porro quisquam est.
                                                </div>
                                            </div>
                                        </blockquote>
                                        <div class="text-content">
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit volu ptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto 
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="post-footer-bls d-sm-flex">
                                <div class="post-socials d-flex">
                                    <span>Share</span>
                                    ...
                                    <a href="#" class="icon-google-plus"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                        ...
                        <div class="post-navigation clearfix">
                            <ul class="prev-next">
                                <li><a href="#" class="prev">Previous Post</a></li>
                                <li class="text-right"><a href="#" class="next">Next Post</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="comments">
                        ...
                        <ul class="comments-list">
                                ...
                                <div class="comment-wrap">
                                    ...
                                    <div class="comment-content">
                                        <div class="comment-meta">
                                            <h5 class="name">Rebbeca Simpson</h5>
                                ...
                                <ul class="sub-comment">
                                    <li>
                                        <div class="comment-wrap">
                                            ...
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    <h5 class="name">Wasap Mamun</h5>
                                                    <span class="comment-time">- 5 hours ago</span>
                                                </div>
                                                <p>
                                                    Excepteur sint occaecat cupidatat non proident, sunt in culpa ser unt mollit anim id est laborum. Sed ut perspiciatis unde om natus error sit vom dolorem que lauda ntium
                                                </p>
                                                <div class="comment-reply">
                                                    <a href="#">Reply</a>
                                                </div>
                                    ...
                                    <li>
                                        <div class="comment-wrap">
                                            <div class="avatar">
                                                <img src="images/blog/05.png" alt="images">
                                            </div>
                                            <div class="comment-content">
                                                <div class="comment-meta">
                                                    <h5 class="name">Kuddus Ali</h5>
                                                    <span class="comment-time">- 5 hours ago</span>
                                                </div>
                                                <p>
                                                    Excepteur sint occaecat cupidatat non proident, sunt in culpa ser unt mollit anim id est laborum. Sed ut perspiciatis unde om natus error sit vom dolorem que lauda ntium
                            ...
                            <li>
                                <div class="comment-wrap">
                                    <div class="avatar">
                                        <img src="images/blog/06.png" alt="images">
                                    </div>
                                    <div class="comment-content">
                                        <div class="comment-meta">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="comment-respond">
                        ...
                        <form action="#" class="form-leave-comment">
                            <div class="message-wrap">
                                <textarea name="comment" id="comment-message" rows="8" placeholder="Write your comment here"></textarea>
                            </div>
                            ...
                            <div class="text-wrap d-md-flex clearfix">
                                ...
                                <div class="w-right">
                                    <input type="text" class="your-website" placeholder="Your website">
                                </div>
                            </div>
                            <div class="fl-btn">
                                <button class="hvr-vertical">submit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- blog-single.php  22 Nov 2019 12:09:35 GMT -->
</html>