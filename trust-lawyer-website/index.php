                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="index-2.php" class="active">Home 1</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#">About</a>
            ...
            <div id="rev-slider1" class="rev_slider fullwidthabanner">
                <ul>
                    ...
                    <li data-transition="random">
                        ...
                        data-splitout="none" 
                        data-responsive_offset="on">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eius mod<br> tempor incitur adi pisicing elit sed do eiusmod 
                        </div>
                        ...
                        data-splitout="none" 
                        data-responsive_offset="on">
                        <a href="#" class="hvr-vertical">read more</a></div>
                    </li>
                    <!-- /End Slide 1 -->
