...
<!-- practice-area.php  22 Nov 2019 12:04:54 GMT -->
<head>
    <meta charset="UTF-8">
    <title>Suprimo</title>
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="practice-area.php" class="active">Practice area</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="featured-post">
                        <div class="entry-image">
                            <img src="images/practice/10.png" alt="images">
                        </div>
                    </div>
                </div>
...
<!-- practice-area.php  22 Nov 2019 12:04:55 GMT -->
</html>